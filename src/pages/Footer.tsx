  ...
  return (
    <div className="absolute flex h-14 bottom-0 left-0 w-full text-white bg-black bg-opacity-50 ">
        ...
        <div className='w-1/5 h-full flex items-center justify-end gap-1'>
            <span className=' hover:bg-gray-500 hover:bg-opacity-10  flex items-center px-1 py-4 rounded-md'><IoIosArrowUp size={16} /></span>
            <span className=' hover:bg-gray-500 hover:bg-opacity-10  flex items-center px-2 py-4 rounded-md'><BsKeyboard size={18} /></span>
            <div className='flex gap-1  hover:bg-gray-500 hover:bg-opacity-10  px-1 items-center py-4 rounded-md'>
            <span><IoWifi size={18} /></span>
            <span><HiOutlineSpeakerWave size={18} /></span>
            <span><IoBatteryChargingOutline size={19} /></span>
            </div>
            <div className=' hover:bg-gray-500 hover:bg-opacity-10 rounded-md py-2 px-1'>
                <div className='flex justify-end'><Clock /></div>
                <div><CurrentDate /></div>
            </div>           
             <span className='hover:bg-gray-500 hover:bg-opacity-10  flex items-center px-1 py-4 rounded-md'><BsFillBellFill size={16} /></span>
