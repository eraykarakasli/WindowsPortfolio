      ...
      <div className="flex items-center">
        <span className="flex items-center justify-between relative  w-[240px]  bg-[#2c2c2c] ml-2 mt-2 p-2  rounded-t-lg">
          <img
            ...
            alt=""
          />
          <span className="text-xs cursor-default px-2 z-20">C:\User\eray\Masaüstü\Portfolio</span>

          <span className="text-lg z-30 text-gray-300 rounded-md  -mr-1 px-2 absolute  right-2 hover:bg-[#383838] bg-[#2c2c2c]">
          <AiOutlineClose className="h-7" size={14} />
          </span>
        </span>
        <span className="text-xl z-40 cursor-default text-gray-300 mx-2 hover:bg-[#2d2d2d] rounded-md -mb-2 px-2 h-6 pb-1 flex items-center">
            +
            </span>
      </div>
      <div className='flex mb-2 z-20'>
